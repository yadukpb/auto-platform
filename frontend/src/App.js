...
import CommunityDetailScreen from './screens/social/CommunityDetailScreen'
import CreateCommunityScreen from './screens/social/CreateCommunityScreen'
import PostDetailScreen from './screens/social/PostDetailScreen'
import CarsListScreen from './components/CarsListScreen'
        ...
        <main className="py-3">
          <Container  fluid style={{paddingRight:'5%',paddingLeft:'5%'}}>
            <Routes>
              ...
              <Route path='/community/create' element={<CreateCommunityScreen />} />
              <Route 
                path='/community/:id' 
                element={
                  <ProtectedRoute>
