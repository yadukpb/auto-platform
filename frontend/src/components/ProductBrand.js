...
const icons = [
  ...
  { name: SiTata, brand: "Tata Motors", category: "Cars" },
  { name: SiHonda, brand: "Honda", category: "Cars" },
  { name: SiHyundai, brand: "Hyundai", category: "Cars" },
  { name: SiToyota, brand: "Toyota", category: "Cars" },
  { name: SiKia, brand: "Kia", category: "Cars" },
  { name: SiVolkswagen, brand: "Volkswagen", category: "Cars" },
  { name: SiAudi, brand: "Audi", category: "Cars" }
];
